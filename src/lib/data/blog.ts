...
export const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    title: {
      ...
      it: "Perché il prospecting basato sui trigger batte il cold outbound ogni volta",
    },
    excerpt: {
      ...
      it: "Il 90% delle cold email finisce nel cestino. Il 10% che riceve risposta ha una cosa in comune: fa riferimento a qualcosa che è appena successo nel business del destinatario. Ecco come costruire un sistema outbound attorno ai trigger event invece che sul volume.",
    },
    category: "insight",
    ...
    metaTitle: {
      ...
      it: "Prospecting Basato sui Trigger | Perché il Cold Outbound Fallisce",
    },
    metaDescription: {
      ...
      it: "Le cold email falliscono perché mancano di contesto. Il prospecting basato sui trigger ancora ogni messaggio a un evento di business reale. Ecco come costruire un sistema outbound che riceve risposte.",
    },
  },
];
