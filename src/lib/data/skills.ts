...
export const categories: {
  ...
  {
    slug: "productivity",
    name: { en: "Productivity", it: "Produttività" },
    icon: "layout-dashboard",
    description: {
      en: "Professional workspace setup, workflow optimization, and cross-functional productivity tools",
      it: "Setup workspace professionale, ottimizzazione workflow e strumenti di produttività trasversali",
    },
  },
];
...
export const skills: SkillDetail[] = [
  ...
  },
  {
    ...
    reviewCount: 0,
    problem: {
      en: "The gap between people experimenting with AI and people operating with AI is no longer a step. It is a canyon. On one side: users who copied a CLAUDE.md from a tutorial, re-explain context every session, close the terminal and lose everything. On the other: professionals whose workspace learns from every interaction, improves overnight, and compounds that advantage day after day. Most Claude Code users sit on the wrong side. No session memory. No agents. No way to measure value. No improvement loop. They use ten percent of the tool and assume that is all there is. Meanwhile, the small percentage who built a real operating system around Claude are pulling further ahead with every session.",
      it: "Il divario tra chi sperimenta con l'AI e chi opera con l'AI non è più un gradino. È un canyon. Da una parte: utenti che hanno copiato un CLAUDE.md da un tutorial, rispiegano il contesto a ogni sessione, chiudono il terminale e perdono tutto. Dall'altra: professionisti il cui workspace impara da ogni interazione, migliora durante la notte e accumula quel vantaggio giorno dopo giorno. La maggior parte degli utenti Claude Code sta dalla parte sbagliata. Nessuna memoria tra sessioni. Nessun agente. Nessun modo per misurare il valore. Nessun ciclo di miglioramento. Usano il dieci percento dello strumento e pensano che sia tutto qui. Nel frattempo, la piccola percentuale che ha costruito un vero sistema operativo attorno a Claude si allontana sempre di più a ogni sessione.",
    },
    solution: {
      en: "Workspace Architect runs a guided setup in eight phases. Phase one is the real differentiator: instead of asking you fifteen generic questions, it reads your actual documents. Drop your CV, paste your LinkedIn URL, point it to your company website. Claude extracts your role, seniority, industry, communication style, and current projects from the source material. Then it confirms what it found and fills the gaps with targeted questions. From there, it generates everything: context files that describe your work and professional identity, a session management system that preserves continuity across conversations, working agents customized for your role, MCP server recommendations with guided installation, a value tracking mechanism that measures ROI in real currency, and a growth roadmap from basic to autonomous workspace. Twenty-four files, all personalized. One execution.",
      it: "Workspace Architect esegue un setup guidato in otto fasi. La prima fase \u00e8 il vero elemento distintivo: invece di farti quindici domande generiche, legge i tuoi documenti reali. Fornisci il CV, incolla l'URL del tuo profilo LinkedIn, indica il sito della tua azienda. Claude estrae ruolo, seniority, settore, stile comunicativo e progetti correnti direttamente dal materiale originale. Poi conferma quello che ha trovato e colma le lacune con domande mirate. Da l\u00ec, genera tutto: file di contesto che descrivono il tuo lavoro e la tua identit\u00e0 professionale, un sistema di gestione sessioni che preserva la continuit\u00e0 tra le conversazioni, agenti funzionanti personalizzati per il tuo ruolo, raccomandazioni di server MCP con installazione guidata, un meccanismo di tracking del valore che misura il ROI in valuta reale e una roadmap di crescita dal workspace base a quello autonomo. Ventiquattro file, tutti personalizzati. Una sola esecuzione.",
    },
    result: {
      en: "After thirty minutes you have a workspace that improves itself. Not once. Every session. The closing process saves context, logs value generated, and queues concrete improvements to your setup. After one week you have five or six optimizations ready. After three weeks, your workspace is unrecognizable compared to day one. Your CLAUDE.md went from four lines to two hundred. Your value tracker shows exactly how many hours Claude saved you, in real currency. This is where the compounding kicks in. While other users start every session from scratch, yours starts at eighty percent context already loaded. The gap widens every day. After a month, you are operating at a level that would take someone starting today weeks to reach. That is the asymmetric advantage: a system that gets better while you sleep.",
      it: "Dopo trenta minuti hai un workspace che si migliora da solo. Non una volta. Ogni sessione. Il processo di chiusura salva il contesto, registra il valore generato e mette in coda miglioramenti concreti al tuo setup. Dopo una settimana hai cinque o sei ottimizzazioni pronte. Dopo tre settimane, il workspace è irriconoscibile rispetto al primo giorno. Il CLAUDE.md è passato da quattro righe a duecento. Il tracker del valore mostra esattamente quante ore Claude ti ha fatto risparmiare, in valuta reale. Qui scatta il compounding. Mentre gli altri utenti ripartono da zero a ogni sessione, la tua parte con l'ottanta percento del contesto già caricato. Il divario si allarga ogni giorno. Dopo un mese, operi a un livello che chi inizia oggi impiegherebbe settimane a raggiungere. Questo è il vantaggio asimmetrico: un sistema che migliora mentre dormi.",
    },
    whatsInside: [
      ...
      { en: "6 personalized templates: context files, professional profile, session management, improvement tracking, value logging, and task backlog", it: "6 template personalizzati: file di contesto, profilo professionale, gestione sessioni, tracking miglioramenti, registro del valore e backlog attività" },
      { en: "Role-specific agents: a universal closing agent plus specialized agents tailored to your role (sales, development, marketing, product, executive, freelance)", it: "Agenti specifici per ruolo: un agente di chiusura universale più agenti specializzati per il tuo ruolo (sales, development, marketing, product, executive, freelance)" },
    ...
    beforeAfter: [
      ...
      },
      {
        ...
        after: { en: "Sessions build on each other: the closing process saves context, logs value, and feeds improvements back into the workspace", it: "Le sessioni costruiscono l'una sull'altra: il processo di chiusura salva il contesto, registra il valore e riporta i miglioramenti nel workspace" },
      },
      {
      ...
      },
      {
        ...
        after: { en: "Built-in value tracking shows time saved per session with your actual hourly rate as benchmark", it: "Il tracking del valore integrato mostra il tempo risparmiato per sessione con la tua tariffa oraria reale come benchmark" },
      },
    ],
    faq: [
      {
        question: { en: "What do I get when I buy this?", it: "Cosa ricevo quando acquisto?" },
        answer: {
          en: "A ZIP with 24 files: the guided workflow, customizable templates for context and session management, agent templates for different professional roles, a document intelligence system, an architecture guide, six role profiles, a growth roadmap, and MCP server installation guides across three tiers. You run the skill once and it generates your entire workspace.",
          it: "Un file ZIP con 24 file: il workflow guidato, template personalizzabili per contesto e gestione sessioni, template agenti per diversi ruoli professionali, un sistema di document intelligence, una guida architetturale, sei profili ruolo, una roadmap di crescita e guide per l'installazione di server MCP su tre livelli. Esegui la skill una volta e genera l'intero workspace.",
        },
      },
      {
      ...
      },
      {
        ...
        answer: {
          en: "Twenty-five to thirty-five minutes for the complete guided setup. Document Intelligence takes three to five minutes if you provide documents, less if you skip it. The heaviest phase is MCP server installation, which is optional. After the initial setup, the workspace maintains itself through the built-in closing process.",
          it: "Venticinque-trentacinque minuti per il setup guidato completo. La Document Intelligence richiede tre-cinque minuti se fornisci documenti, meno se la salti. La fase pi\u00f9 impegnativa \u00e8 l'installazione dei server MCP, che \u00e8 opzionale. Dopo il setup iniziale, il workspace si mantiene da solo attraverso il processo di chiusura integrato.",
        },
      },
    ],
