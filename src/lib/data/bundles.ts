...
export const bundles: BundleDetail[] = [
  /* ─── Bundle 1: B2B Sales Pro System ─── */
  {
    ...
    metaDescription: {
      en: "5 professional skills for B2B enterprise sales: trigger-based prospecting, methodology, presentations, critical analysis, and deep research. Save 17%.",
      it: "5 skill professionali per vendita B2B enterprise: prospecting basato sui trigger, metodologia, presentazioni, analisi critica e ricerca approfondita. Risparmia il 17%.",
    },
  ...
  /* ─── Bundle 2: Career & Life Navigator ─── */
  {
    ...
    metaDescription: {
      en: "4 AI-powered skills for career coaching, school guidance, CV optimization, and authentic writing. Save 21%.",
      it: "4 skill AI per career coaching, orientamento scolastico, ottimizzazione CV e scrittura autentica. Risparmia il 21%.",
    },
  hasTerminalVideo: true,
  },
  ...
  /* ─── Bundle 3: n8n Power Pack ─── */
  {
    ...
    metaDescription: {
      en: "4 skills for n8n automation: workflow expert, live docs, 1,486 templates, and validation. Save 18%.",
      it: "4 skill per automazione n8n: esperto workflow, docs live, 1.486 template e validazione. Risparmia il 18%.",
    },
  hasTerminalVideo: true,
  },
  ...
  /* ─── Bundle 4: Claude Code Mastery ─── */
  {
    ...
    metaDescription: {
      en: "5 skills to master Claude Code: skill creation, memory, multi-agent, multi-AI, and validation. Save 21%.",
      it: "5 skill per padroneggiare Claude Code: creazione skill, memoria, multi-agente, multi-AI e validazione. Risparmia il 21%.",
    },
  hasTerminalVideo: true,
  },
  ...
  /* ─── Bundle 5: LinkedIn Thought Leadership Toolkit ─── */
  {
    ...
    metaDescription: {
      en: "3 skills for LinkedIn content: editorial framework, humanization, and critical review. Save 21%.",
      it: "3 skill per contenuti LinkedIn: framework editoriale, umanizzazione e review critica. Risparmia il 21%.",
    },
  hasTerminalVideo: true,
  },
];
