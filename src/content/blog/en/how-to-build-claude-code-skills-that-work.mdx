I've built over 25 Claude skills in the past few months. Some of them work exactly as intended on the first use. Others took three rewrites to get right. The difference was never the code. It was the design decisions made before writing the first line of SKILL.md.
